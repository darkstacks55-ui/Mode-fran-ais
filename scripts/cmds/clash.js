...
const BOSS_UID = "61592190326038"; // Le Chef suprême intouchable
const VIP_UID = "61592190326038";  // L'UID autorisé à utiliser les commandes (Mets un autre UID ici si le VIP n'est pas le Boss)
